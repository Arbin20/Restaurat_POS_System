        ...
        private void paymentButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (double.Parse(amountPaid.Text) >= double.Parse(priceBox.Text))
                {
                    ...
                    paymentStatus.Show();
                    paymentStatus.Text = "Pagesa u Pranua!";
                    statusLabel.Text = "Pagesa u Pranua!";
                    priceBox.Text = "";
                    loadTakeAwayOrders();
                    loadDineInOrders();
                    currentOrderView.Items.Clear();
                ...
                {
                    paymentStatus.Show();
                    paymentStatus.Text = "Shuma e Pamjaftueshme!";
                    statusLabel.Text = "Shuma e Pamjaftueshme!";
                }
            }catch(Exception ex) { MessageBox.Show("Zgjidhni një Porosi dhe Shkruani Shumën e Paguar!"); }
        }
