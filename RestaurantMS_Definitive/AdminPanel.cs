...
namespace RestaurantMS_Definitive
{
    public partial class AdminPanel : MaterialForm
    {
        ...
        private void itemIDText_TextChanged(object sender, EventArgs e)
        {

        }

        private void itemCategoryText_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void itemPriceText_TextChanged(object sender, EventArgs e)
        {
        ...
        private void catogoryChoice_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void itemCatogory_Click(object sender, EventArgs e)
        {
